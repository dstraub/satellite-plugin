...
public class PluginConfiguration extends GlobalConfiguration  {
     ...
     * doTestSshUser
     */
    public FormValidation doCheckSshUser(@QueryParameter("sshUser") String sshUser, @QueryParameter("sshKeyPath") String sshKeyPath, @QueryParameter("sshPassword") String sshPassword) throws IOException, ServletException {
